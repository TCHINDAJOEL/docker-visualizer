...
const Terminal = ({ history, onExecute, onClear, mode }) => {
    ...
    return (
        <div className="h-1/3 min-h-[200px] border-t border-white/10 bg-black/80 backdrop-blur-xl flex flex-col shadow-[0_-4px_20px_rgba(0,0,0,0.5)] z-10">
            ...
            >
                ...
                <input
                    ...
                    placeholder="docker run -it ubuntu bash"
                    spellCheck={false}
                />
            </form>
        </div>
